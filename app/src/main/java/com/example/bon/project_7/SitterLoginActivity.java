...
//        NetworkUtil.setNetworkPolicy();
    ...
    private void login() {
        ...
        if (userid.toString().length() == 0) {
            Toast.makeText(SitterLoginActivity.this, "아이디를 입력", Toast.LENGTH_SHORT).show();
        } else if (userpass.toString().length() == 0) {
            Toast.makeText(SitterLoginActivity.this, "비밀번호를 입력", Toast.LENGTH_SHORT).show();
        } else {
        ...
        class UserLoginClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                if(s.equalsIgnoreCase("success")) {
                    Intent intent = new Intent(SitterLoginActivity.this,NavigatActivity.class);
                    startActivity(intent);
                    finish();
                    Toast.makeText(SitterLoginActivity.this,"로그인 성공하였습니다.",Toast.LENGTH_LONG).show();
                } else {
